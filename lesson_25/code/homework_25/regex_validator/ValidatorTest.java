...
class ValidatorTest {
    ...
    void checkDateFormatEU() {
        ...
        assertTrue(Validator.checkDateFormatEU("26/02/2023"));
    ...
    void checkDateFormatUS() {
        ...
        assertTrue(Validator.checkDateFormatUS("2024.10.15"));
        assertTrue(Validator.checkDateFormatUS("2024/10/15"));
        assertTrue(Validator.checkDateFormatUS("1999-12-31"));
        assertFalse(Validator.checkDateFormatUS("2024-13-01"));
        assertFalse(Validator.checkDateFormatUS("2024-02-30"));
        assertFalse(Validator.checkDateFormatUS("2024-2-10"));
        assertFalse(Validator.checkDateFormatUS("24.10.15"));
        assertFalse(Validator.checkDateFormatUS("2024/00/10"));
        assertFalse(Validator.checkDateFormatUS("2024-11-32"));
        assertFalse(Validator.checkDateFormatUS("abcd-10-15"));
    }
