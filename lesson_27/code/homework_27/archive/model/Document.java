...
public class Document extends Archive{
    ...
    //constructor
    public Document(Document[] documents, int size, String title, String author, long numberOfDocument, int date, int pages) {
        super(documents, size);
        this.title = title;
        this.author = author;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), title, author, numberOfDocument, date, pages);
    }
