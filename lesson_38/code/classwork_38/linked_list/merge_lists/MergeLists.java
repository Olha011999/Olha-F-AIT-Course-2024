package classwork_38.linked_list.merge_lists;
...
public class MergeLists {
    ...
    public static void main(String[] args) {
        ArrayList<Integer> list1 = new ArrayList<>(List.of(3, 5, 1, 9, 3));//с помощью new обращаемся к конструктору для получения аргументов
