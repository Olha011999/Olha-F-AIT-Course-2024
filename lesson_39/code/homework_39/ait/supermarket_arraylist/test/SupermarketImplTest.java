package homework_39.ait.supermarket_arraylist.test;

import homework_39.ait.supermarket_arraylist.dao.Supermarket;
import homework_39.ait.supermarket_arraylist.dao.SupermarketImpl;
...
class SupermarketImplTest {
    ...
    void findProductsWithExpiredDate() {
        ...
        Iterable<Product> expected = Arrays.asList(products[1], products[4]);//просроченные
        assertIterableEquals(actual, expected);
    }
